 ...
 * Project: Cinda
 */
public class MyContributions extends Fragment {
     ...
     */
    public static MyContributions newInstance(ArrayList<ItemProfile> items) {

        MyContributions fragment = new MyContributions();
